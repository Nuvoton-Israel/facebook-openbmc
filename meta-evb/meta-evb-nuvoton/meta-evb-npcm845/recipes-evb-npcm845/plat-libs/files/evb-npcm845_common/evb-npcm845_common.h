...
#ifndef __EVB_NPCM845_COMMON_H__
#define __EVB_NPCM845_COMMON_H__
...
int evb_npcm845_common_set_fru_i2c_isolated(uint8_t fru, uint8_t val);
int evb_npcm845_common_is_bic_ready(uint8_t fru, uint8_t *val);
int evb_npcm845_common_server_stby_pwr_sts(uint8_t fru, uint8_t *val);
int evb_npcm845_common_get_bmc_location(uint8_t *id);
int evb_npcm845_common_get_fru_id(char *str, uint8_t *fru);
int evb_npcm845_common_check_slot_id(uint8_t fru);
int evb_npcm845_common_get_slot_id(char *str, uint8_t *fru);
int evb_npcm845_common_get_bus_id(uint8_t slot_id);
int evb_npcm845_common_is_fru_prsnt(uint8_t fru, uint8_t *val);
int evb_npcm845_common_get_slot_type(uint8_t fru);
int evb_npcm845_common_get_sb_rev(uint8_t fru);
int evb_npcm845_common_get_1ou_m2_prsnt(uint8_t fru);
int evb_npcm845_common_get_sb_pch_bic_pwr_fault(uint8_t fru);
int evb_npcm845_common_get_sb_cpu_pwr_fault(uint8_t fru);
int evb_npcm845_common_get_sb_bic_boot_strap(uint8_t fru);
int evb_npcm845_common_get_bb_rev(void);
int evb_npcm845_common_crashdump(uint8_t fru, bool ierr, bool platform_reset);
int evb_npcm845_common_dev_id(char *str, uint8_t *dev);
int evb_npcm845_common_dev_name(uint8_t dev, char *str);
int evb_npcm845_common_get_2ou_board_type(uint8_t fru, uint8_t *board_type);
int evb_npcm845_common_fscd_ctrl (uint8_t mode);
int evb_npcm845_common_check_image_signature(uint8_t board_id, uint8_t *data);
int evb_npcm845_common_get_img_ver(const char* image_path, char* ver, uint8_t comp);
int evb_npcm845_common_check_image_md5(const char* image_path, int cal_size, uint8_t *data, bool is_first, uint8_t comp, uint8_t board_id);
uint8_t evb_npcm845_zero_checksum_calculate(uint8_t *buf, uint8_t len);
bool evb_npcm845_is_zero_checksum_valid(uint8_t *buf, uint8_t len);
bool evb_npcm845_common_is_valid_img(const char* img_path, uint8_t comp, uint8_t board_id, uint8_t rev_id);
int evb_npcm845_common_get_bb_hsc_type(uint8_t* type);
bool evb_npcm845_common_is_prot_card_prsnt(uint8_t fru) ;
...
#endif /* __EVB_NPCM845_COMMON_H__ */
