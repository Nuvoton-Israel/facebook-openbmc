...
enum {
  ...
  //BMC - sensors
  BMC_SENSOR_TMP100_TEMP = 0x00,
  BMC_SENSOR_ADC0_VOLT = 0x01,
  BMC_SENSOR_ADC1_VOLT = 0x02,
  BMC_SENSOR_ADC2_VOLT = 0x03,
  BMC_SENSOR_ADC3_VOLT = 0x04,
  BMC_SENSOR_ADC4_VOLT = 0x05,
  BMC_SENSOR_ADC5_VOLT = 0x06,
  BMC_SENSOR_ADC6_VOLT = 0x07,
  BMC_SENSOR_ADC7_VOLT = 0x08,
  BMC_SENSOR_FAN0_TACH = 0x09,
  BMC_SENSOR_FAN1_TACH = 0x0A,
  BMC_SENSOR_FAN2_TACH = 0x0B,
  BMC_SENSOR_FAN3_TACH = 0x0C,
};
